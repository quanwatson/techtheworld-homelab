...
| Metric | Value |
|---|---|
| **All-time hours logged** | 0 |
| **This week's hours** (week of 2026-09-14) | 0 |
| **Last logged session** | none yet |
| **Sessions logged** | 0 |
...
|---|---|---|---|
| — | — | — | *No sessions logged yet. First entry lands here the next time you confirm training mode.* |
...
|---|---|---|
| 2026-09-14 | 0 | Program setup week — pre-kickoff (§5–9 Phase 0) |
